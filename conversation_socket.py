...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            # Process the audio chunk (e.g., save it to a file or process it directly)
            with open("received_audio.wav", 'ab') as f:
                f.write(audio_chunk)

            # Transcribe the audio chunk
            await get_transcript(handle_full_sentence, AudioSegment.from_file("received_audio.wav"))
